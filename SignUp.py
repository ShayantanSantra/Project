...
class FirstList(BoxLayout):
    ...
    def set(self):
        ...
        self.straddress = self.aw('Street Address',inp = None)
    ...
    def getdata(self):
        self.FirstListItem = []
        if self.check() == True:
            self.FirstListI = [self.firstname,self.lastname,self.email,self.phoneno,self.username,self.password,self.straddress,self.city]
...
class SignUpScreen(Screen,BoxLayout):
    ...
    def getdata(self):
        ...
        self.query = 'INSERT INTO userdata VALUES ('
