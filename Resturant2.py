...
class ResMenu2(TabbedPanel,BoxLayout):
    def set(self):
...
class ResTitle2(BoxLayout):
        # Main title of the Application
    def set(self):
        self.size_hint = (1, .1)
        self.pos_hint = {'top': 1, 'center_x': 0.5}

class ResScreen2(Screen,BoxLayout):
    def set(self):
...
class ResScreenM2(ScreenManager):
    def set(self):
        self.R = ResScreen2()
        self.R.set()
        self.add_widget(self.R)

class ResScreen2App(App):
    def build(self):
        self.s = ResScreenM2()
        self.s.set()
